...
func (t *MTCProbe) dumpTcSkb(tcEvent *TcSkbEvent) error {
...
func (t *MTCProbe) writePid(tcEvent *TcSkbEvent) (error, []byte) {
...
func (t *MTCProbe) createPcapng(netIfs []net.Interface) error {
	pcapFile, err := os.OpenFile("/home/caffein/project/cacapture/test.pcapng", os.O_TRUNC|os.O_WRONLY|os.O_CREATE, 0644)
	if err != nil {
